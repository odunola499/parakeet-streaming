...
class ConformerAttention(nn.Module):
    ...
    def forward(self, x:Tensor, pos_emb:Tensor, attn_mask:Tensor):
        B, T = x.shape[:2]
        ...
        pos = self.linear_pos(pos_emb).view(pos_emb_B, -1, self.num_heads, self.d_k).transpose(1, 2)
